  ...
  return (
    <section id="hero" style={{
      ...
      <motion.p {...fadeUp(0.2)} style={{
        ...
        Hi, I'm <strong style={{ color: 'var(--text)', fontWeight: 500 }}>Asim Ali Raza</strong> — I build fast, beautiful mobile apps
        <br />with{' '}
        <TypeAnimation
          sequence={['Flutter', 1500, 'Firebase', 1500, 'API Integaration', 1500, ' Rest API', 1500, 'Provider', 1500, 'GetX', 1500]}
          repeat={Infinity}
      ...
      <motion.div {...fadeUp(0.3)} style={{ display: 'flex', gap: 14, marginBottom: 32 }}>
        {[
          {
            label: 'GitHub', href: 'https://asimaliraz.github.io',
          ...
          {
            label: 'LinkedIn', href: 'https://linkedin.com/in/asim-ali-raza-5201892ba',
          ...
          {
            label: 'Email', href: 'mailto:asimaliraza0987@gmail.com',
